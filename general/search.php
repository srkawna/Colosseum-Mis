...
<div id="center">
  ...
  <div id="resultpane" style="width:90%">
  <p class="ui-widget-header" style="text-align:left;margin-left:10%;margin-bottom:0px;">Search Results</p>
  
  <div id="res" style="width: 100%;
				height: 200px;
				overflow: auto;margin-top:0px;">
    
  <table  id="resultpane1" width="100%" style="padding-left:10%;z-index:-12;margin-top:0px;">
